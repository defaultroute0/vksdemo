...
holuser@console:~$ ls
blank.html   Documents   noproxy.sh     Templates            VKS-CAPI-Webhook-Troubleshooting.md
checkfw.err  Downloads   Pictures       thinclient_drives    vks-capi-webhook-troubleshoot.sh
creds.txt    egwagent    Public         vcfa-cert-chain.pem  watchvcfa.log
cronfile     hol         README.md      vcf-cli-linux_amd64
Desktop      install.sh  sha256sum.txt  vcf-cli.tar.gz
desktop-hol  Music       snap           Videos
holuser@console:~$ cat VKS-CAPI-Webhook-Troubleshooting.md 
